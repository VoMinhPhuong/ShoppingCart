...
{
    public class OrderHeaderReponsitory : Repository<OrderHeader>, IOrderHeaderRepository
    {
        private ShoppingDbContext _context;

        public OrderHeaderReponsitory(ShoppingDbContext context): base(context)
        {
            _context = context;
        }
        ...
        public void PaymentStatus(int Id, string SessionId, string PaymentIntentId)
        {
            ...
            orderHeader.PaymentIntendId = PaymentIntentId;
